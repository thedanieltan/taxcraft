...
test("lists maintained jurisdictions and exposes source-linked coverage", async () => {
  ...
  const yearCases = [
    ...
    ["LC", ["2026"]],
    ["NA", ["2025", "2026", "2027"]],
    ...["KR", "KZ", "TN", "SI", "SK", "AT", "TR", "PE", "CO", "GR", "JO", "JE", "AD", "ZM", "ME", "CN", "TW", "MX", "MO", "MA", "EG", "DZ", "GG", "NL", "US", "NO", "CA", "JP", "ES", "IT", "MT", "PT", "DE", "FR", "LU", "CH", "BE", "DK", "FI", "SE"].map((code) => [code, ["2026"]]),
    ["IN", ["2026-27"]],
    ["EC", ["2025"]],
    ["BR", ["2025"]],
    ["IM", ["2026-27"]],
  ...
  const coverageCases = [
    ...
    ["AD", "2026", "ad.govern.irpf-effective-rates"],
    ["ZM", "2026", "zm.parliament.income-tax-amendment-2023"],
    ["ME", "2026", "me.tax-administration.personal-earnings-rates-current"],
    ["CN", "2026", "cn.sta.individual-income-tax-law-comprehensive"],
    ["TW", "2026", "tw.mof.progressive-tax-rate-2026"],
    ["MX", "2026", "mx.sat.rmf-2026-annex-8-annual-tariff"],
    ...
    ["LR", "2026", "lr.lra.employee-pit-table"],
    ["LC", "2026", "lc.ird.individual-income-tax-rates"],
    ["NA", "2027", "na.gazette.income-tax-amendment-2024"],
    ["KR", "2026", "kr.law.income-tax-act-article-55-2026"],
    ["KZ", "2026", "kz.tax-code-2026-article-363"],
    ["TN", "2026", "tn.mof.irpp-scale-current-ar"],
    ["SI", "2026", "si.official-gazette-income-tax-parameters-2026"],
    ["SK", "2026", "sk.fa.individual-income-tax-rates-2026"],
    ["AT", "2026", "at.ris.income-tax-act-section-33-2026"],
    ["TR", "2026", "tr.gib.income-tax-tariff-2026"],
    ["PE", "2026", "pe.sunat.uit-2026"],
    ["CO", "2026", "co.dian.uvt-2026-resolution-238"],
    ["GR", "2026", "gr.minfin.income-taxation-2026"],
    ["JO", "2026", "jo.istd.income-tax-law-current"],
    ["JE", "2026", "je.revenue.tax-allowances-2026"],
    ["EC", "2025", "ec.sri.general-regime-table-2025"],
    ["BR", "2025", "br.rfb.irpf-annual-table-2025"],
    ["MO", "2026", "mo.budget-2026-professional-tax-relief"],
    ...
    ["IN", "2026-27", "in.income-tax.ay-2026-27-individual-rates"],
    ["CA", "2026", "ca.cra.tax-rates-2026"],
    ["JP", "2026", "jp.nta.income-tax-rates-2026"],
    ["ES", "2026", "es.aeat.state-general-scale-2025-current"],
    ["IT", "2026", "it.inps.irpef-reduction-2026"],
    ["IE", "2026", "ie.revenue.usc-standard-rates"],
    ["PL", "2026", "pl.mf.joint-spouse-calculation"],
    ["MT", "2026", "mt.mtca.individual-tax-rates-2026"],
    ["PT", "2026", "pt.at.cirs-article-68-2026"],
    ...
    ["BE", "2026", "be.fps-finance.pit-rates-2026"],
    ["DK", "2026", "dk.skat.am-contribution-2026"],
    ["FI", "2026", "fi.vero.state-earned-income-scale-2026"],
    ["SE", "2026", "se.skatteverket.state-income-tax-2026"],
  ];
