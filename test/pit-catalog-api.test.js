...
const IMPLEMENTED_CODES = [
  "SG", "GB", "AE", "BH", "BM", "BN", "KY", "MC", "OM", "QA", "SA", "VG", "BS", "KW", "BG", "EE", "HU", "RO", "AM", "GE", "MD", "MK", "UA", "UZ", "NZ", "PY", "CY", "PA", "HN", "DO", "BB", "TT", "SC", "UG", "GT", "RW", "AU", "PH", "TH", "FJ", "BW", "TL", "KH", "AD", "ZM", "ME", "CN", "TW", "MX", "KE", "ZA", "MY", "CZ", "ID", "GH", "MU", "LK", "SZ", "JM", "LS", "GY", "LR", "LC", "NA", "KR", "KZ", "TN", "SI", "SK", "AT", "TR", "PE", "CO", "GR", "JO", "JE", "EC", "BR", "MO", "MA", "EG", "DZ", "GG", "NL", "HK", "US", "NO", "IN", "CA", "JP", "ES", "IT", "IE", "PL", "MT", "PT", "DE", "IM", "FR", "LU", "CH", "BE", "DK", "FI", "SE",
];
const VERIFIED_CODES = ["SG", "AE", "SA", "VG", "BS", "KW", "EE", "NZ", "CY", "AM", "UA", "UZ", "PA", "HN", "DO", "BB", "TT", "SC", "UG", "GT", "RW", "AU", "PH", "TH", "FJ", "BW", "TL", "KH", "AD", "ZM", "KE", "ZA", "MY", "CZ", "ID", "GH", "MU", "LK", "SZ", "JM", "LS", "GY", "LR", "LC", "NA", "KR", "KZ", "TN", "SI", "SK", "AT", "TR", "PE", "CO", "GR", "JO", "JE", "EC", "BR", "MO", "MA", "EG", "DZ", "GG", "NL", "HK", "US", "IE", "PL", "MT", "PT", "DE", "IM", "FR", "LU", "CH", "BE", "DK", "FI", "SE", "NO", "CN", "TW", "MX", "IN", "CA", "JP", "ES", "IT"];
...
test("runtime catalogue exposes all registered PIT jurisdictions", () => {
  ...
  assert.equal(status.counts.implemented, 105);
  assert.equal(status.counts["source-indexed"], 60);
...
test("implemented model input schemas are public and unimplemented models fail explicitly", async () => {
  const cases = [
    ...
    ["GG", "2026", ["scopeConfirmed", "chargeableIncomeMinor"]],
    ["NL", "2026", ["scopeConfirmed", "ageSchedule", "box1TaxableIncomeMinor", "aggregateIncomeForGeneralCreditMinor", "employmentIncomeForEmploymentCreditMinor"]],
    ["HK", "2025-26", ["scopeConfirmed", "netIncomeMinor", "netChargeableIncomeMinor"]],
    ["US", "2026", ["scopeConfirmed", "filingStatus", "taxableIncomeMinor"]],
    ["NO", "2026", ["scopeConfirmed", "standardOrdinaryIncomeRateConfirmed", "salaryNationalInsuranceScheduleConfirmed", "ordinaryIncomeTaxBaseMinor", "personalIncomeMinor", "salaryIncomeForNationalInsuranceMinor"]],
    ["IN", "2026-27", ["scopeConfirmed", "taxRegime", "residentRebateSchedule", "taxableIncomeMinor"]],
    ["CA", "2026", ["scopeConfirmed", "province", "federalTaxableIncomeMinor", "provincialTaxableIncomeMinor"]],
    ["JP", "2026", ["scopeConfirmed", "taxableIncomeMinor"]],
    ["ES", "2026", ["scopeConfirmed", "generalTaxableBaseMinor", "personalFamilyMinimumMinor"]],
    ["IT", "2026", ["scopeConfirmed", "nationalTaxableIncomeMinor", "regionalTaxableIncomeMinor", "municipalTaxableIncomeMinor", "regionalRateBasisPoints", "municipalRateBasisPoints"]],
    ...
    ["LU", "2026", ["scopeConfirmed", "taxClass", "adjustedTaxableIncomeMinor"]],
    ...
    ["BE", "2026", ["scopeConfirmed", "taxableIncomeMinor", "municipalSurchargeBasisPoints"]],
    ["DK", "2026", ["scopeConfirmed", "employmentIncomeSubjectToAmMinor", "municipalTaxableIncomeMinor", "municipalTaxRateBasisPoints"]],
    ["FI", "2026", ["scopeConfirmed", "stateTaxableEarnedIncomeMinor", "municipalTaxableEarnedIncomeMinor", "municipalTaxRateBasisPoints"]],
    ["SE", "2026", ["scopeConfirmed", "stateTaxableEarnedIncomeMinor", "municipalTaxableEarnedIncomeMinor", "municipalTaxRateBasisPoints"]],
  ];
