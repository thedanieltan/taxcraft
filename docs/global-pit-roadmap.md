...
| WP-PIT-02 | Global PIT rule map | 85 implemented; 80 source-indexed; 84 active discovery entries; all 249 structurally routed |
...
- 85 implemented calculators;
- 80 source-indexed jurisdictions awaiting implementation;
