...
| WP-PIT-02 | Global PIT rule map | 56 implemented; 108 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–10 integrated |
...
- 56 implemented calculators;
- 108 source-indexed jurisdictions awaiting implementation;
