...
| WP-PIT-02 | Global PIT rule map | 74 implemented; 90 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–25 integrated |
| WP-PIT-12 | Household and filing-status systems | Waves 1–4 integrated |
...
- 74 implemented calculators;
- 90 source-indexed jurisdictions awaiting implementation;
