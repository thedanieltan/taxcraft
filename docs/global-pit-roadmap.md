...
| WP-PIT-02 | Global PIT rule map | 57 implemented; 107 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–11 integrated |
...
- 57 implemented calculators;
- 107 source-indexed jurisdictions awaiting implementation;
