...
| WP-PIT-02 | Global PIT rule map | 72 implemented; 92 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–24 integrated |
...
- 72 implemented calculators;
- 92 source-indexed jurisdictions awaiting implementation;
