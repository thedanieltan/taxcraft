...
| WP-PIT-02 | Global PIT rule map | 38 implemented; 126 source-indexed; 85 in discovery |
...
| WP-PIT-10 | Simple-progressive packages | Waves 1–6 integrated; wave 7 implemented, acceptance pending |
...
- 38 implemented calculators;
- 126 source-indexed jurisdictions awaiting implementation;
