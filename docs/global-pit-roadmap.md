...
| WP-PIT-02 | Global PIT rule map | 55 implemented; 109 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–9 integrated |
...
- 55 implemented calculators;
- 109 source-indexed jurisdictions awaiting implementation;
