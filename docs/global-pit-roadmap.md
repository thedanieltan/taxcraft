...
| WP-PIT-02 | Global PIT rule map | 65 implemented; 99 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–18 integrated |
...
- 65 implemented calculators;
- 99 source-indexed jurisdictions awaiting implementation;
