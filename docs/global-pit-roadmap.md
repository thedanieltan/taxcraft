...
| WP-PIT-02 | Global PIT rule map | 45 implemented; 119 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-10 | Simple-progressive packages | Waves 1–8 integrated; wave 9 implemented, acceptance pending |
...
- 45 implemented calculators;
- 119 source-indexed jurisdictions awaiting implementation;
