...
| WP-PIT-02 | Global PIT rule map | 89 implemented in the current branch; 76 source-indexed; 84 active discovery entries; all 249 structurally routed |
...
| WP-PIT-10 | Simple-progressive packages | Waves 1–14 integrated |
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–33 integrated |
...
| WP-PIT-15 | Complex composite systems | Wave 1 integrated; wave 2 implemented pending repository acceptance |
| WP-PIT-16 | Source-maintenance consolidation | Planned |
| WP-PIT-17 | Global deployment and live acceptance | Planned |

## Current coverage

The current branch runtime catalogue contains all 249 ISO 3166-1 countries and territories:

- 89 implemented calculators, including the pending-acceptance United States wave;
- 76 source-indexed jurisdictions awaiting implementation;
...
Planning, source indexing, implementation, repository acceptance, deployment and live acceptance remain separate states.
...
- `docs/progressive-reliefs-packages-wave-30.md`
- `docs/progressive-reliefs-packages-wave-31.md`
- `docs/progressive-reliefs-packages-wave-32.md`
- `docs/progressive-reliefs-packages-wave-33.md`
- `docs/complex-composite-packages.md`
- `docs/complex-composite-packages-wave-2.md`
