...
| WP-PIT-02 | Global PIT rule map | 64 implemented; 100 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–17 integrated |
...
- 64 implemented calculators;
- 100 source-indexed jurisdictions awaiting implementation;
