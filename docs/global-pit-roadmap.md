...
| WP-PIT-02 | Global PIT rule map | 51 implemented; 113 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
- 51 implemented calculators;
- 113 source-indexed jurisdictions awaiting implementation;
