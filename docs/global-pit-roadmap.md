...
| WP-PIT-02 | Global PIT rule map | 66 implemented; 98 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–19 integrated |
...
- 66 implemented calculators;
- 98 source-indexed jurisdictions awaiting implementation;
