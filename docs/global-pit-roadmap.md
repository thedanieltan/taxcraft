...
| WP-PIT-10 | Simple-progressive packages | Waves 1–2 integrated; wave 3 implemented, acceptance pending |
...
- simple-progressive scopes for New Zealand, Paraguay, Cyprus, Panama, Honduras, the Dominican Republic, Barbados, Seychelles and Trinidad and Tobago.
