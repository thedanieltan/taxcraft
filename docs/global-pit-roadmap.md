...
| WP-PIT-02 | Global PIT rule map | 73 implemented; 91 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
- 73 implemented calculators;
- 91 source-indexed jurisdictions awaiting implementation;
