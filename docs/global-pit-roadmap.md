...
| WP-PIT-02 | Global PIT rule map | 80 implemented; 85 source-indexed; 84 active discovery entries; all 249 structurally routed |
...
| WP-PIT-10 | Simple-progressive packages | Waves 1–12 integrated |
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–28 integrated |
...
- 80 implemented calculators;
- 85 source-indexed jurisdictions awaiting implementation;
...
- simple-progressive scopes for New Zealand, Paraguay, Cyprus, Panama, Honduras, the Dominican Republic, Barbados, Seychelles, Trinidad and Tobago, Uganda, Guatemala, Rwanda, Australia, the Philippines, Thailand, Fiji, Botswana, Timor-Leste, Cambodia and Andorra;
- progressive-reliefs scopes for Kenya, South Africa, Malaysia, the Czech Republic, Indonesia, Ghana, Mauritius, Sri Lanka, Eswatini, Jamaica, Lesotho, Guyana, Liberia, Saint Lucia, Namibia, South Korea, Kazakhstan, Tunisia, Slovenia, Slovakia, Austria, Türkiye, Peru, Colombia, Greece, Jordan, Jersey, Ecuador and Brazil;
