...
| WP-PIT-02 | Global PIT rule map | 88 implemented; 77 source-indexed; 84 active discovery entries; all 249 structurally routed |
...
- 88 implemented calculators;
- 77 source-indexed jurisdictions awaiting implementation;
