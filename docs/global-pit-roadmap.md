...
| WP-PIT-02 | Global PIT rule map | 68 implemented; 96 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–21 integrated |
...
- 68 implemented calculators;
- 96 source-indexed jurisdictions awaiting implementation;
