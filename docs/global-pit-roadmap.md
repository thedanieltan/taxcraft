...
| WP-PIT-02 | Global PIT rule map | 67 implemented; 97 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–20 integrated |
...
- 67 implemented calculators;
- 97 source-indexed jurisdictions awaiting implementation;
