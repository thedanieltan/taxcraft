...
| WP-PIT-02 | Global PIT rule map | 59 implemented; 105 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–13 integrated |
...
- 59 implemented calculators;
- 105 source-indexed jurisdictions awaiting implementation;
