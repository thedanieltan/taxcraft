...
| WP-PIT-02 | Global PIT rule map | 76 implemented; 88 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
- 76 implemented calculators;
- 88 source-indexed jurisdictions awaiting implementation;
