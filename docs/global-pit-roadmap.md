...
| WP-PIT-02 | Global PIT rule map | 75 implemented; 89 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-12 | Household and filing-status systems | Waves 1–5 integrated |
...
- 75 implemented calculators;
- 89 source-indexed jurisdictions awaiting implementation;
