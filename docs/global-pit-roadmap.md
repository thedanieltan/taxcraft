...
| WP-PIT-02 | Global PIT rule map | 81 implemented; 84 source-indexed; 84 active discovery entries; all 249 structurally routed |
...
- 81 implemented calculators;
- 84 source-indexed jurisdictions awaiting implementation;
