...
| WP-PIT-02 | Global PIT rule map | 50 implemented; 114 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-10 | Simple-progressive packages | Waves 1–10 integrated |
...
- 50 implemented calculators;
- 114 source-indexed jurisdictions awaiting implementation;
...
- simple-progressive scopes for New Zealand, Paraguay, Cyprus, Panama, Honduras, the Dominican Republic, Barbados, Seychelles, Trinidad and Tobago, Uganda, Guatemala, Rwanda, Australia, the Philippines, Thailand, Fiji, Botswana and Timor-Leste;
