...
| WP-PIT-02 | Global PIT rule map | 31 implemented; 133 source-indexed; 85 in discovery |
...
| WP-PIT-10 | Simple-progressive packages | Waves 1–3 integrated; wave 4 implemented, acceptance pending |
| WP-PIT-11 | Progressive systems with deductions and credits | Planned |
...
- 31 implemented calculators;
- 133 source-indexed jurisdictions awaiting implementation;
...
- simple-progressive scopes for New Zealand, Paraguay, Cyprus, Panama, Honduras, the Dominican Republic, Barbados, Seychelles, Trinidad and Tobago, Uganda and Guatemala.
