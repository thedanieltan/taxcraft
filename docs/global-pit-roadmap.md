...
| WP-PIT-02 | Global PIT rule map | 60 implemented; 104 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–14 integrated |
...
- 60 implemented calculators;
- 104 source-indexed jurisdictions awaiting implementation;
