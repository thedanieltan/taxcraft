...
| WP-PIT-02 | Global PIT rule map | 71 implemented; 93 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–23 integrated |
| WP-PIT-12 | Household and filing-status systems | Waves 1–3 integrated |
...
- 71 implemented calculators;
- 93 source-indexed jurisdictions awaiting implementation;
