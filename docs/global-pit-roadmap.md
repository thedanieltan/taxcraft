...
| WP-PIT-02 | Global PIT rule map | 52 implemented; 112 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–6 integrated |
...
- 52 implemented calculators;
- 112 source-indexed jurisdictions awaiting implementation;
