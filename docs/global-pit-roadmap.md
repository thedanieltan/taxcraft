...
| WP-PIT-02 | Global PIT rule map | 70 implemented; 94 source-indexed; 85 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–22 integrated |
...
- 70 implemented calculators;
- 94 source-indexed jurisdictions awaiting implementation;
...
- progressive-reliefs scopes for Kenya, South Africa, Malaysia, the Czech Republic, Indonesia, Ghana, Mauritius, Sri Lanka, Eswatini, Jamaica, Lesotho, Guyana, Liberia, Saint Lucia, Namibia, South Korea, Kazakhstan, Tunisia, Slovenia, Slovakia, Austria, Türkiye and Peru;
