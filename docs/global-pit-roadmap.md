...
| WP-PIT-02 | Global PIT rule map | 84 implemented; 81 source-indexed; 84 active discovery entries; all 249 structurally routed |
...
| WP-PIT-11 | Progressive systems with deductions and credits | Waves 1–31 integrated |
...
- 84 implemented calculators;
- 81 source-indexed jurisdictions awaiting implementation;
...
- progressive-reliefs scopes for Kenya, South Africa, Malaysia, the Czech Republic, Indonesia, Ghana, Mauritius, Sri Lanka, Eswatini, Jamaica, Lesotho, Guyana, Liberia, Saint Lucia, Namibia, South Korea, Kazakhstan, Tunisia, Slovenia, Slovakia, Austria, Türkiye, Peru, Colombia, Greece, Jordan, Jersey, Ecuador, Brazil, Macao, Morocco and Egypt;
